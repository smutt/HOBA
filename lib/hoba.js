...
/*
  make_auth_header_chal: function hoba_make_auth_header_chal(provided_chal, origin, tbsorigin){
...
//  get_tbsorigin: function hoba_get_tbsorigin(uri){

exports.get_tbsorigin = function(uri){
...
// scheme:auth:port (no slashes)
exports.get_origin = function(uri){
  dump("\nEntering get_origin()")
  return exports.get_tbsorigin(uri).replace("://", ":");
};
